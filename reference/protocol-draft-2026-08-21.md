<!--
PROVENANCE: verbatim snapshot of radio-robot-lib/docs/design/protocol.md,
taken 2026-08-21 for sprint 007 ticket 012 (nezha-upy).

  Upstream repo:     radio-robot-lib
  Base commit:       c99e6e8af8386b4c9637bb0e903450ed868d21a1 (2026-08-21 15:37:48 -0700)
  Working tree state: UNCOMMITTED -- `git status --short -- docs/design/protocol.md`
                       showed ` M docs/design/protocol.md` at snapshot time.
  Snapshot date:      2026-08-21

This file is this ticket's (and ticket 013's) design authority from this
point forward -- not the live upstream file. If the upstream working tree
moves again before this lands, that is out of scope for this snapshot.
Everything below the next line is copied verbatim, unedited.
-->
